 ...
 */
inline polygonf_t::ring_type convert(const polygon_t::ring_type& r) {
 ...
 */
inline polygonf_t convert(const polygon_t& p) {
	polygonf_t pf;
 ...
 */
inline void write_svg(std::string const& filename, const std::vector<segment_t>& segments) {
 ...
 * @param ring The ring
 */
inline void write_svg(std::string const& filename, const polygon_t& p, const polygon_t::ring_type& ring) {
	std::ofstream svg(filename.c_str());
 ...
 */
inline void write_svg(std::string const& filename, typename std::vector<polygon_t> const& polygons) {
	std::ofstream svg(filename.c_str());
 ...
 */
inline void write_svg(std::string const& filename, const polygon_t& pA, const polygon_t & pB, const nfp_t& nfp) {
	polygon_t nfppoly;
