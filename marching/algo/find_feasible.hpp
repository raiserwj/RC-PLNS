 ...
 */
inline std::vector<TranslationVector> find_feasible_translation_vectors(polygon_t::ring_type& ringA, polygon_t::ring_type& ringB, const std::vector<TouchingPoint>& touchers) {
