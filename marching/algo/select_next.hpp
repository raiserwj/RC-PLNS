...
#include "marching/geometry.hpp"
#include "marching/translation_vector.hpp"
#include "marching/history.hpp"
 ...
 */
inline TranslationVector find_longest(const std::vector<TranslationVector>& tvs) {
	coord_t len;
 ...
 */
inline void sort_by_length(std::vector<TranslationVector>& tvs) {
 ...
 * @param tvs The std::vector to sort.
 */
inline void sort_by_history_count(const History& history, std::vector<TranslationVector>& tvs) {
	std::sort( tvs.begin( ), tvs.end( ), [&]( const TranslationVector& lhs, const TranslationVector& rhs ) {
 ...
 */
inline TranslationVector select_next_translation_vector(const nfp_t& nfp, const polygon_t& pA, const polygon_t::ring_type& rA, const polygon_t::ring_type& rB, std::vector<TranslationVector> feasibleVectors, const History& history) {
