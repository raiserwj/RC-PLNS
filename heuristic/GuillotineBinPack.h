...
public:
	...
	GuillotineBinPack(double width, double height);
	...
	Rect Insert(double width, double height,int rotate, int id, bool merge, FreeRectChoiceHeuristic rectChoice, GuillotineSplitHeuristic splitMethod);
...
//		FreeRectChoiceHeuristic rectChoice, GuillotineSplitHeuristic splitMethod);
	...
	double score(double width, double height,int rotate, FreeRectChoiceHeuristic rectChoice);
...
private:
	...
	Rect FindPositionForNewNode(double width, double height,int rotate, FreeRectChoiceHeuristic rectChoice, int *nodeIndex);

	static int ScoreByHeuristic(double width, double height, const Rect &freeRect, FreeRectChoiceHeuristic rectChoice);
	...
	static int ScoreBestAreaFit(double width, double height, const Rect &freeRect);
	static int ScoreBestShortSideFit(double width, double height, const Rect &freeRect);
	static int ScoreBestLongSideFit(double width, double height, const Rect &freeRect);

	static int ScoreWorstAreaFit(double width, double height, const Rect &freeRect);
	static int ScoreWorstShortSideFit(double width, double height, const Rect &freeRect);
	static int ScoreWorstLongSideFit(double width, double height, const Rect &freeRect);
